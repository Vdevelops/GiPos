...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card/96 text-card-foreground flex flex-col gap-5 rounded-2xl border border-border/80 py-5 shadow-sm transition-[box-shadow,transform,border-color] duration-200 hover:border-ring/20 hover:shadow",
        className
      )}
      {...props}
    />
